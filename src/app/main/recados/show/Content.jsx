...
import { saveOne, newData, getOne, updateOne, updateResponse} from '../store/recadoSlice';

function Content() {
	const dispatch = useDispatch();
	const routeParams = useParams();
	const history = useHistory();
	const productRedux = useSelector(({ recado }) => recado);

	console.log("productReduxvfdvfdvfdvfdvdfvfdvfdvfdv")
