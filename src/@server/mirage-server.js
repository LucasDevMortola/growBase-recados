...
// 			server.create('recado', {
// 				id: 1,
// 				description: 'desenvolver dash',
// 				details: 'padrao bootstrap'
// 			});
...
// 				return { success: true, data: { category: result }, message: 'Categoria cadastra com sucesso.' };
// 			});
...
// 			this.get('/recados', schema => {
// 				const result = schema.recados.all();
// 				console.log(result);
// 				return { success: true, data: { recados: result.models } };
// 			});
